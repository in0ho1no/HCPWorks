...
`hcpworks.ShowName` | boolean | `true` | `Name:` フィールドをプレビュー・エクスポートに表示するかどうか。
`hcpworks.ShowScope` | boolean | `true` | `scope:` フィールドをプレビュー・エクスポートに表示するかどうか。
`hcpworks.ShowKind` | boolean | `true` | `kind:` フィールドをプレビュー・エクスポートに表示するかどうか。
